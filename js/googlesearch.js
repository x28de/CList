...
(function () {
    const googHandler = {
        ...
        statusActions: (item,itemID,itemLink) => {
            return `<button class="clist-action-btn" title="Open in browser" onClick="openInBrowser('${itemLink}', '${itemID}')"><span class="material-icons md-18 md-light">launch</span></button>`;
        },
        feedFunctions: {
